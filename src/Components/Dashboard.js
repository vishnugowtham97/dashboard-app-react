...
import CardDisplay from '../Cardbody/CardDisplay';
import ColorSystem from '../Cardbody/ColorSystem';
import ProjectCard from '../Cardbody/ProjectCard';
                        ...
                        <div id="content">
                                ...
                                <ul className="navbar-nav ml-auto">
                                    ...
                                    <li className="nav-item dropdown no-arrow">
                                        <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span className="mr-2 d-none d-lg-inline text-gray-600 small">Vishnu B</span>
                            ...
                            <div className="container-fluid">
                                ...
                                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 className="h3 mb-0 text-gray-800">Vishnu Dashboard</h1>
